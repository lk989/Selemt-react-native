    ...
    return (
        <View className="my-4">
            ...
            <View className="relative flex justify-end h-full">
                ...
                <TouchableOpacity
                className="bg-light-green mx-6 my-2 rounded flex-row justify-start items-center px-4 py-2"
                underlayColor='#fff'
                onPress={() => {setIsBarcodeModalVisible(false); setIsOperationModalVisible(true);}}>
                    <SText text='initiate-report' classes="text-center text-lg text-black p-2"/>
                <Icon name='car-crash' type='font-awesome-5' color='#fff' size={24}/>
                </TouchableOpacity>
                <TouchableOpacity
                className="bg-light-green mx-6 my-2 rounded flex-row justify-start items-center px-4 py-2 mb-5"
                underlayColor='#fff'
                onPress={() => {setIsBarcodeModalVisible(false); navigation.navigate('ObjectionsSection')}}>
                    <SText text='Raise-objection' classes="text-center text-lg text-black p-2"/>
                <Icon name='alert-circle' type='ionicon' color='#fff' size={24}/>
                </TouchableOpacity>
                </View>
            </View>
            </Modal>
